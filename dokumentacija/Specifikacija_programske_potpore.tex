\chapter{Specifikacija programske potpore}
		...
		\section{Ostali zahtjevi}
			...
			\begin{itemize}
	        	\item 	\textit{Sustav treba podržati rad više korisnika u stvarnom vremenu bez gubitaka funkcionalnosti}
	        	\item 	\textit{Prikaz i tekstualni unos mora podržavati hrvatske dijakritičke znakove}
	        	\item 	\textit{Sustav treba biti jednostavan za korištenje, korisnici se moraju znati koristiti web sučeljem i sustavom bez opširnih uputa }
	        	\item 	\textit{Sustav bi trebao jamčiti točnost i pouzdanost informacija u aplikaciji}
	        	\item 	\textit{Ažuriranje i nadogradnja sustava ne smije narušavati postojeće funkcionalnosti sustava}
	        	\item 	\textit{Baza podataka mora biti brza i zaštićena od bilo kakvih vanjskih utjecaja}
	        	\item 	\textit{Odgovor na korisnikov upit koji je povezan sa bazom podatak bi trebao biti najduže par sekundi}
	        	\item 	\textit{Nepravilne akcije korisnika, trenera ili voditelja u korisničkom sučelju ne smiju narušiti postojeće funkcionalnosti sustava}
	        	\item 	\textit{Sustav kao valutu dopušta euro ili hrvatsku kunu}
	        	\item 	\textit{Sustavu se treba moći pristupiti iz javne mreže sigurnim protokolom(HTTPS)}
        	\end{itemize}
