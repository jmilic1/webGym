	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Sekvencijski dijagrami}
				...
				\textit{Nacrtati sekvencijske dijagrame koji modeliraju najvažnije dijelove sustava (max. 4 dijagrama). Ukoliko postoji nedoumica oko odabira, razjasniti s asistentom. Uz svaki dijagram napisati detaljni opis dijagrama.}
                    ...
                    \begin{figure}[H]
			            \includegraphics[scale=1.0]{slike/UC10.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			            \centering
                    ...
                    \begin{figure}[H]
			            \includegraphics[scale=1.0]{slike/UC13.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			            \centering
                    ...
                    \begin{figure}[H]
			            \includegraphics[scale=1.0]{slike/UC15.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			            \centering
                    ...
                    \begin{figure}[H]
			            \includegraphics[scale=1.0]{slike/UC16.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			            \centering
