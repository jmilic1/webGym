\chapter{Specifikacija programske potpore}
		...
		\eject
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Klijent odabire određenu teretanu
							\item Klijentu se prikazuje ponuda vrsta članarina
							\item Klijent odabire opciju članarine koju želi platiti
						\end{packed_enum}
						...
						Klijent pokušava kupiti članarinu u teretani u kojoj već ima aktivnu članarinu istog tipa
							\item[] \begin{packed_enum}
								...
								\item Sustav obavještava klijenta da već postoji aktivna članarina tog tipa
				...
				\begin{packed_item}
					...
					\item  \textbf{Sudionici:} Baza podataka
					\item  \textbf{Preduvjet:} Klijent je prijavljen i napravio je narudžbu
					\item  \textbf{Opis osnovnog tijeka:}
				...
				\begin{packed_item}
					...
					\item  \textbf{Sudionici:} Baza podataka
					\item  \textbf{Preduvjet:} Klijent je prijavljen i odabrao je promjenu svojih podataka
					\item  \textbf{Opis osnovnog tijeka:}
					...
					\item[] \begin{packed_enum}
						...
						\item Postavljanje novih ciljeva i izmjena postojećih (može ga se izmijeniti ili postaviti kao odrađenog)
					\end{packed_enum}
				...
				\begin{figure}[!htb]
					\includegraphics[height= 13cm,width=1.2\textwidth]{dijagrami/obrazac1.jpg}
				...
				\begin{figure}
					...
					\includegraphics[height=13cm,width=1.2\textwidth]{dijagrami/obrazac2.jpg}
					
					\textbf{Slika 3.2: Dijagram obrasca uporabe, funkcionalnost korisnika i trenera u aplikaciji}
				\end{figure}
				
				\begin{figure}
					\includegraphics[height= 13cm,width=1.2\textwidth]{dijagrami/obrazac3.jpg}
			...
			\subsection{Sekvencijski dijagrami}
                    ...
                    \begin{figure}[H]
			            \includegraphics[scale=0.9]{dijagrami/UC10.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			            \centering
                    ...
                    \begin{figure}[H]
			            \includegraphics[scale=0.9]{dijagrami/UC13.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			            \centering
                    ...
                    te web aplikacija iz baze podataka povlači informacije o programu te ih prikazuje treneru.
                    ...
                    \begin{figure}[H]
			            \includegraphics[scale=0.9]{dijagrami/UC15.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			            \centering
					...
					\textit{}Trener šalje zahtjev za popis svih teretana te web aplikacija dohvaća popis
                    iz baze podataka te ih prikazuje treneru. Trener potom odabire teretanu za 
                    koju je zainteresiran, a podaci o teretani se ponovno dohvaćaju iz baze podataka.
                    ...
                    \begin{figure}[H]
			            \includegraphics[scale=0.9]{dijagrami/UC17.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			            \centering
		...
		\section{Ostali zahtjevi}
			...
			\begin{itemize}
	        	...
	        	\item 	Odgovor na korisnikov upit koji je povezan sa bazom podataka trebao bi trajati najduže par sekundi
