\chapter{Specifikacija programske potpore}
		...
		\section{Ostali zahtjevi}
			...
			\begin{itemize}
	        	\item 	\textit{Korisničko sučelje i sustav moraju podržavati hrvatsku abecedu (dijakritičke znakove) pri unosu i prikazu tekstualnog sadržaja}
	        	...
	        	\item 	\textit{Nadogradnja sustava ne smije narušavati postojeće funkcionalnosti sustava}
	        	\item 	\textit{Veza s bazom podataka mora biti kvalitetno zaštićena, brza i otporna na vanjske greške}
	        	\item 	\textit{Odgovor na korisnikov upit koji je povezan sa bazom podatak bi trebao biti njaduže par sekundi}
	        	...
	        	\item 	\textit{Pristup sustavu mora biti omogućen iz javne mreže pomoću HTTPS}
        	\end{itemize}
