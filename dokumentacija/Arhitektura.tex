...
>>>>>>> devdoc
	...
	\end{itemize}
		...
		\begin{figure}
			\includegraphics[height= 13cm,width=1.2\textwidth]{dokumentacija/slike/ControllerClass.jpg}
			\begin{center}
			    Slika 4.3: Dijagram razreda - dio Controllers
			\end{center}
		\end{figure}
		\begin{figure}
			\includegraphics[height= 13cm,width=1.2\textwidth]{dokumentacija/slike/DTOClass.jpg}
			\begin{center}
		...
		\end{figure}
		\begin{figure}
			\includegraphics[height= 20cm,width=1.2\textwidth]{dokumentacija/slike/modelsClass.jpg}
