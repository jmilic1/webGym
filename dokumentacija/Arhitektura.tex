\chapter{Arhitektura i dizajn sustava}
	...
	\end{itemize}
		...
		\textbf{Korisnik} Ovaj entitet sadržava sve bitne informacije o korisniku WebGym web aplikacije. Sadrži atribute kao što su: korisničko ime, ime, prezime, email, hashiranu lozinku, broj mobitela, broj PayPala, visinu, težinu te ulogu u sustavu. U ulozi ovise ovlasti koje korisnik u sustavu i u odnosima ima. Ovaj entitet je u vezi s entitetom Ciljevi preko korisničkog imena klijenta koji je i sam korisnik, u vezi s entitetom PlanTreningaIPrehrane preko korisničkog imena trenera koji je i sam korisnik, u vezi s entitetom ČlanarinaKlijent preko korisničkog imena klijenta, u vezi s entitetom prijava preko korisničkog imena trenera, u vezi s entitetom PlanKlijent preko korisničkog imena klijenta te u vezi s entitetom TeretanaKorisnik preko korisničkog imena trenera ili voditelja koji su i sami korisnici.
				...
				\textbf{Teretana} ovaj entitet sadrži sve bitne informacije o lancu teretani. Sadrži atribute: id, ime, opis te email, a ovaj je entitet u vezi s entitetom TeretanaLokacija preko jedinstvenog brojčanog identifikatora teretane te u vezi s entitetom članarina preko jedinstvenog brojčanog identifikatora teretane.
				\begin{longtabu} to \textwidth {|X[6, l]|X[6, l]|X[20, l]|}
			...
			\textbf{TeretanaLokacija} ovaj entitet sadrži sve bitne informacije o pojedinoj teretani. Sadrži atribute: id,id lanca teretani, država u kojoj se nalazi, grad u kojem se nalazi, ulica u kojoj se nalazi, početak ranog vremena teretane, kraj radnog vremena teretane te broj telefona teretane, a ovaj je entitet u vezi s entitetom Teretana preko jedinstvenog brojčanog identifikatora teretane, u vezi s entitetom Prijava preko jedinstvenog brojčanog identifikatora pojedine teretane te je u vezi s entitetom TeretanaKorisnik preko jedinstvenog brojčanog identifikatora pojedine teretane.
			\begin{longtabu} to \textwidth {|X[6, l]|X[6, l]|X[20, l]|}
			...
			\textbf{Ciljevi} ovaj entitet sadrži sve važne informacije o ciljevima samog klijenta. Sadrži atribute: id,korisničko ime klijenta te opis cilja, a ovaj je entitet u vezi s entitetom Korisnik preko korisničkog imena.
			\begin{longtabu} to \textwidth {|X[6, l]|X[6, l]|X[20, l]|}
			...
			\textbf{Članarina} ovaj entitet sadrži sve važne informacije o članarini u teretani.  Sadrži atribute: id,id pojedine teretane, cijena članarine, opis te trajanje, a ovaj je entitet u vezi s entitetom Teretana preko jedinstvenog brojčanog identifikatora teretane.
			\begin{longtabu} to \textwidth {|X[6, l]|X[6, l]|X[20, l]|}
			...
			\textbf{ČlanarinaKlijent} ovaj entitet sadrži sve važne informacije o članarini koju klijent posjeduje. Sadrži atribute: id,korisničko ime klijenta, id članarine koju teretana nudi, datum početka te dazum isteka trajanja članarine, a ovaj je entitet u vezi s entitetom Korisnik preko korisničkog imena klijenta te je u vezi s entitetom Članarina preko jedinstvenog brojčanog identifikatora članarine.
			\begin{longtabu} to \textwidth {|X[6, l]|X[6, l]|X[20, l]|}
			...
			\textbf{Prijava} ovaj entitet sadrži sve važne informacije o prijavi za posao koju trener šalje pojedinoj teretani. Sadrži atribute: id,korisničko ime trenera, id pojedine teretane u kojoj se trener za posao prijavljuje, te opis prijave, a ovaj je entitet u vezi s entitetom Korisnik preko korisničkog imena trenera te je u vezi s entitetom Teretana preko jedinstvenog brojčanog identifikatora teretane.
			\begin{longtabu} to \textwidth {|X[6, l]|X[6, l]|X[20, l]|}
			...
			\textbf{PlanKlijent} ovaj entitet sadrži sve važne informacije o planu prehrane i treninga kojeg klijent posjeduje. Sadrži atribute: id, id plana, korisničko ime klijenta, te datum kupnje, a ovaj je entitet u vezi s entitetom Korisnik preko korisničkog imena klijenta te je u vezi s entitetom PlanTreningaIPrehrane preko jedinstvenog brojčanog identifikatora plana.
			\begin{longtabu} to \textwidth {|X[6, l]|X[6, l]|X[20, l]|}
			...
			\textbf{TeretanaKorisnik} ovaj entitet sadrži sve važne informacije o korisniku koji radi u teretani kao voditelj ili kao trener. Sadrži atribute: id, id pojedine teretane, korisničko ime korisnika, te datum početka rada, a ovaj je entitet u vezi s entitetom Korisnik preko korisničkog imena korisnika te je u vezi s entitetom TeretanaLokacija preko jedinstvenog brojčanog identifikatora pojedine teretane.
			\begin{longtabu} to \textwidth {|X[6, l]|X[6, l]|X[20, l]|}
